...
const data = {
  "key": "v-41c2a7b8",
  "path": "/Vue/%E5%9F%BA%E7%A1%80%E6%A6%82%E5%BF%B5+vuecli+%E6%8C%87%E4%BB%A4%E4%B8%8A.html",
  "title": "vue基本概念",
  "lang": "zh-CN",
  "frontmatter": {},
  "excerpt": "",
  "headers": [
    ...
    },
    {
      ...
      "children": [
        ...
        {
          "level": 3,
          "title": "v-else 和 v-else-if",
          "slug": "v-else-和-v-else-if",
          "children": []
        }
      ]
    },
    {
      ...
      "children": [
        ...
        {
          "level": 3,
          "title": "v-model 处理其他表单元素",
          "slug": "v-model-处理其他表单元素",
          "children": []
        },
        {
          "level": 3,
    ...
    {
      "level": 2,
      "title": "v-text 和 v-html",
      "slug": "v-text-和-v-html",
      "children": [
        {
          "level": 3,
          "title": "v-text指令",
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./docs/.vuepress/.temp/pages/Vue/基础概念+vuecli+指令上.html.vue?vue&type=template&id=9c87cfaa
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="通过插值表达式显示数据" tabindex="-1"><a class="header-anchor" href="#通过插值表达式显示数据" aria-hidden="true">#</a> 通过插值表达式显示数据</h2><p>插值表达式, 小胡子语法 mustach语法<code>${
    (0,server_renderer.ssrInterpolate)()
  }</code></p><ol><li><p>作用: 使用 data 中的数据渲染视图（模板）</p></li><li><p>基本语法, 支持三元运算符</p><div class="language-jsx ext-jsx line-numbers-mode"><pre class="language-jsx"><code><span class="token punctuation">{</span><span class="token punctuation">{</span> msg <span class="token punctuation">}</span><span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div></li></ul><h2 id="v-text-和-v-html" tabindex="-1"><a class="header-anchor" href="#v-text-和-v-html" aria-hidden="true">#</a> v-text 和 v-html</h2><h3 id="v-text指令" tabindex="-1"><a class="header-anchor" href="#v-text指令" aria-hidden="true">#</a> v-text指令</h3><ul><li>解释：更新元素的 <code>textContent/innerText</code>。如果要更新部分的 <code>textContent</code> ，需要使用 <code>${
    (0,server_renderer.ssrInterpolate)(_ctx.Mustache)
  }</code> 插值。</li></ul><div class="language-html ext-html line-numbers-mode"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h1</span> <span class="token attr-name">v-text</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>msg<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h1</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p><strong>在网站上动态渲染任意 HTML 是非常危险的，因为容易导致 <a href="https://en.wikipedia.org/wiki/Cross-site_scripting" target="_blank" rel="noopener noreferrer">XSS 攻击`)
  _push((0,server_renderer.ssrRenderComponent)(_component_ExternalLinkIcon, null, null, _parent))
  _push(`</a>。</strong></p><p><strong>只在可信内容上使用 <code>v-html</code>，<strong>永不</strong>用在用户提交的内容上。</strong></p><!--]-->`)
}
;// CONCATENATED MODULE: ./docs/.vuepress/.temp/pages/Vue/基础概念+vuecli+指令上.html.vue?vue&type=template&id=9c87cfaa

// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(3744);
;// CONCATENATED MODULE: ./docs/.vuepress/.temp/pages/Vue/基础概念+vuecli+指令上.html.vue
...
/* harmony default export */ const _vuecli_html = (__exports__);

/***/ })

};
;
//# sourceMappingURL=107.app.js.map